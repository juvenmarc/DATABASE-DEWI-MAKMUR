        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Tambah Customer <!-- <small>different form elements</small> --></h2>
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-5 col-sm-5 col-xs-12">
                        <input type="text" id="nama-cust" name="nama-cust" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-3 col-sm-3 col-xs-12">
												<input type="text" id="cp-cust" name="cp-cust" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
												<input type="number" id="no-telp-cust" name="no-telp-cust" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-8 col-sm-8 col-xs-12">
                        <input type="textarea" id="almt-cust" name="almt-cust" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kota-cust">Kota Customer <span class="required">*</span></label>
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="kota-cust" name="kota-cust" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" class="btn btn-success" name="submit">Submit</button>
									...
									<?php if(isset($_POST['submit'])){
										$nama_customer = $_POST['nama-cust'];
										$cp_customer = $_POST['cp-cust'];
										$alamat_customer = $_POST['almt-cust'];
										$kota_customer = $_POST['kota-cust'];
										$no_telp_customer = $_POST['no-telp-cust'];
										$sql_input_customer = "INSERT INTO `db_customer` (`nama_customer`, `cp_customer`, `alamat_customer`, `kota_customer`, `no_telp_customer`) VALUES ('$nama_customer', '$cp_customer', '$alamat_customer', '$kota_customer', '$no_telp_customer')";
										$conn->query($sql_input_customer);

...
<head>
  ...
  <link rel="shortcut icon" href="../DM.png" />
  <title>Data | Data Gudang Produk</title>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stok-gp">Stok <span class="required">*</span></label>
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="number" id="stok-gp" name="stok-gp" required="required" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" class="btn btn-success" name="submit">Submit</button>
									...
									<?php if(isset($_POST['submit'])){
										...
										$volume = $_POST['stok-gp'];
										$sql_update_gp = "INSERT INTO `db_gudang_produk` (`id_produk`,`volume`) VALUES ('$id_produk','$volume')";
										$conn->query($sql_update_gp);

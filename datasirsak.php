...
//cari rata-rata simple average
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12003' AND tahun = '2014'";
	$q=mysql_query($sql);
	...
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12003' AND tahun = '2015'";
	$q=mysql_query($sql);
	while ($row = mysql_fetch_array($q)){ 
	...
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12003' AND tahun = '2016'";
	$q=mysql_query($sql);
	while ($row = mysql_fetch_array($q)){ 
 ...
 //sampai sini cari rata rata Simple average	
				...
				$sql="SELECT sum(jan) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				...
				$sql="SELECT sum(feb) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(mar) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(apr) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(mei) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(jun) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(jul) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(agu) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(sep) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(okt) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(nov) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(des) as jumlah FROM db_forecast WHERE id_produk ='12003'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
	...
	//cari kebutuhan bahan
		if ($bahanjan = $dekomjan*52.5+($dekomjan*52.5*0.03)){ //Januari
			//echo "<br>Hasil Kebutuhan Bahan Januari : $bahanjan Gram</br>"; 
			}
		if ($bahanfeb = $dekomfeb*52.5+($dekomfeb*52.5*0.03)){ //Februari
			//echo "<br>Hasil Kebutuhan Bahan Februari : $bahanfeb Gram</br>"; 
			}
		if ($bahanmar = $dekommar*52.5+($dekommar*52.5*0.03)){ //Maret
			//echo "<br>Hasil Kebutuhan Bahan Maret : $bahanmar Gram</br>"; 
			}
		if ($bahanapr = $dekomapr*52.5+($dekomapr*52.5*0.03)){ //April
			//echo "<br>Hasil Kebutuhan Bahan April : $bahanapr Gram</br>"; 
			}
		if ($bahanmei = $dekommei*52.5+($dekommei*52.5*0.03)){ //Mei
			//echo "<br>Hasil Kebutuhan Bahan Mei : $bahanmei Gram</br>"; 
			}
		if ($bahanjun = $dekomjun*52.5+($dekomjun*52.5*0.03)){ //Juni
			//echo "<br>Hasil Kebutuhan Bahan Juni : $bahanjun Gram</br>"; 
			}
		if ($bahanjul = $dekomjul*52.5+($dekomjul*52.5*0.03)){ //Juli
			//echo "<br>Hasil Kebutuhan Bahan Juli : $bahanjul Gram</br>"; 
			}
		if ($bahanagu = $dekomagu*52.5+($dekomagu*52.5*0.03)){ //Agustus
			//echo "<br>Hasil Kebutuhan Bahan Agustus : $bahanagu Gram</br>";
			}
		if ($bahansep = $dekomsep*52.5+($dekomsep*52.5*0.03)){ //September
			//echo "<br>Hasil Kebutuhan Bahan September : $bahansep Gram</br>"; 
			}
		if ($bahanokt = $dekomokt*52.5+($dekomokt*52.5*0.03)){ //Oktober
			//echo "<br>Hasil Kebutuhan Bahan Oktober : $bahanokt Gram</br>"; 
			}
		if ($bahannov = $dekomnov*52.5+($dekomnov*52.5*0.03)){ //November
			//echo "<br>Hasil Kebutuhan Bahan November : $bahannov Gram</br>"; 
			}
		if ($bahandes = $dekomdes*52.5+($dekomdes*52.5*0.03)){ //Desember

...
//cari rata-rata simple average
 ...
 //sampai sini cari rata rata Simple average	
	...
	//cari kebutuhan bahan
		if ($bahanjan = (($dekomjan*52.5)*0.6)+($dekomjan*52.5*0.03*0.6)){ //Januari
			//echo "<br>Hasil Kebutuhan Bahan Januari : $bahanjan Gram</br>"; 
			}
		if ($bahanfeb = (($dekomfeb*52.5)*0.6)+($dekomfeb*52.5*0.03*0.6)){ //Februari
			//echo "<br>Hasil Kebutuhan Bahan Februari : $bahanfeb Gram</br>"; 
			}
		if ($bahanmar = (($dekommar*52.5)*0.6)+($dekommar*52.5*0.03*0.6)){ //Maret
			//echo "<br>Hasil Kebutuhan Bahan Maret : $bahanmar Gram</br>"; 
			}
		if ($bahanapr = (($dekomapr*52.5)*0.6)+($dekomapr*52.5*0.03*0.6)){ //April
			//echo "<br>Hasil Kebutuhan Bahan April : $bahanapr Gram</br>"; 
			}
		if ($bahanmei = (($dekommei*52.5)*0.6)+($dekommei*52.5*0.03*0.6)){ //Mei
			//echo "<br>Hasil Kebutuhan Bahan Mei : $bahanmei Gram</br>"; 
			}
		if ($bahanjun = (($dekomjun*52.5)*0.6)+($dekomjun*52.5*0.03*0.6)){ //Juni
			//echo "<br>Hasil Kebutuhan Bahan Juni : $bahanjun Gram</br>"; 
			}
		if ($bahanjul = (($dekomjul*52.5)*0.6)+($dekomjul*52.5*0.03*0.6)){ //Juli
			//echo "<br>Hasil Kebutuhan Bahan Juli : $bahanjul Gram</br>"; 
			}
		if ($bahanagu = (($dekomagu*52.5)*0.6)+($dekomagu*52.5*0.03*0.6)){ //Agustus
			//echo "<br>Hasil Kebutuhan Bahan Agustus : $bahanagu Gram</br>";
			}
		if ($bahansep = (($dekomsep*52.5)*0.6)+($dekomsep*52.5*0.03*0.6)){ //September
			//echo "<br>Hasil Kebutuhan Bahan September : $bahansep Gram</br>"; 
			}
		if ($bahanokt = (($dekomokt*52.5)*0.6)+($dekomokt*52.5*0.03*0.6)){ //Oktober
			//echo "<br>Hasil Kebutuhan Bahan Oktober : $bahanokt Gram</br>"; 
			}
		if ($bahannov = (($dekomnov*52.5)*0.6)+($dekomnov*52.5*0.03*0.6)){ //November
			//echo "<br>Hasil Kebutuhan Bahan November : $bahannov Gram</br>"; 
			}
		if ($bahandes = (($dekomdes*52.5)*0.6)+($dekomdes*52.5*0.03*0.6)){ //Desember

...
//cari rata-rata simple average
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12001' AND tahun = '2014'";
	$q=mysql_query($sql);
	...
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12001' AND tahun = '2015'";
	$q=mysql_query($sql);
	while ($row = mysql_fetch_array($q)){ 
	...
	$sql="SELECT jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des FROM db_forecast WHERE id_produk ='12001' AND tahun = '2016'";
	$q=mysql_query($sql);
	while ($row = mysql_fetch_array($q)){ 
 ...
 //sampai sini cari rata rata Simple average	
				...
				$sql="SELECT sum(jan) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				...
				$sql="SELECT sum(feb) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(mar) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(apr) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(mei) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(jun) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(jul) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(agu) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(sep) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(okt) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(nov) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 
				...
				$sql="SELECT sum(des) as jumlah FROM db_forecast WHERE id_produk ='12001'";
				$q=mysql_query($sql);
				while ($rows = mysql_fetch_array($q)){ 

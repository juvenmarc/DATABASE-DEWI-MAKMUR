...
$queri = "SELECT db_bbm.*, db_transaksi_bahan.id_tb, db_transaksi_bahan.tanggal_perlu, db_bahan.nama_bahan FROM db_bbm 
												INNER JOIN db_transaksi_bahan ON db_bbm.id_tb=db_transaksi_bahan.id_tb 
												INNER JOIN db_bahan ON db_bbm.id_bahan=db_bahan.id_bahan where id_bbm = '$id'";
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="aksi_edit_bbm.php" method="post">
                    ...
                    <div class="form-group">
					  ...
					  <input type="hidden" name="id-bbm" value="<?php echo "$nomor";?>">
                      <div class="input-group col-md-5 col-sm-5 col-xs-12">
                        <select class="form-control" id="id-bahan" name="id-bahan" required="required">
							<option value="<?php echo "$idbahan";?>"> <?php echo "$namabahan";?></option>
										...
										<?php	$ddl_tb=$conn->query("SELECT id_tb FROM db_transaksi_bahan"); ?>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-5 col-sm-5 col-xs-12">
                        <select class="form-control" id="id-tb" name="id-tb" required="required">
							<option value="<?php echo "$Idtb";?>"> <?php echo "$Idtb";?></option>
												<?php	if($ddl_tb->num_rows>0) {
													while($rows=$ddl_tb->fetch_assoc()) {
														echo "<option value=" . $rows['id_tb'] . ">" . $rows['id_tb'] . "</option>";
													} 
												}?>
                        </select>
                      </div>
										...
										<div class="form-group">
											...
											<div class="input-group col-md-3 col-sm-3 col-xs-12">
												...
												<input type="date" id="tgl-masuk" name="tgl-masuk" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo "$Tgl";?>">
											</div>
										</div>
					<div class="form-group">
                      ...
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="vol-bbm" name="vol-bbm" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo "$Volume";?>">
                      </div>
                    </div>

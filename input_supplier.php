        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Tambah Supplier <!-- <small>different form elements</small> --></h2>
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-5 col-sm-5 col-xs-12">
                        <input type="text" id="nama-supl" name="nama-supl" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-3 col-sm-3 col-xs-12">
												<input type="text" id="cp-supl" name="cp-supl" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
												<input type="number" id="no-telp-supl" name="no-telp-supl" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-8 col-sm-8 col-xs-12">
                        <input type="textarea" id="almt-supl" name="almt-supl" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kota-supl">Kota Supplier <span class="required">*</span></label>
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="kota-supl" name="kota-supl" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" class="btn btn-success" name="submit">Submit</button>
									...
									<?php if(isset($_POST['submit'])){
										$nama_supplier = $_POST['nama-supl'];
										$cp_supplier = $_POST['cp-supl'];
										$alamat_supplier = $_POST['almt-supl'];
										$kota_supplier = $_POST['kota-supl'];
										$no_telp_supplier = $_POST['no-telp-supl'];
										$sql_input_supplier = "INSERT INTO `db_supplier` (`nama_supplier`, `cp_supplier`, `alamat_supplier`, `kota_supplier`, `no_telp_supplier`) VALUES ('$nama_supplier', '$cp_supplier', '$alamat_supplier', '$kota_supplier', '$no_telp_supplier')";
										$conn->query($sql_input_supplier);

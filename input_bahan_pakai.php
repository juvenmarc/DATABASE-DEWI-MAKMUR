          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="input_bahan_pakai.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="jml" name="jml" required="required" class="form-control col-md-7 col-xs-12">
										...
										<div class="form-group">
											...
											<div class="input-group col-md-3 col-sm-3 col-xs-12">
												...
												<input type="date" id="tgl-pakai" name="tgl-pakai" required="required" class="form-control col-md-7 col-xs-12">
											</div>
										</div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" class="btn btn-success" name="submit">Submit</button>
									...
									<?php if(isset($_POST['submit'])){
										...
										$jumlah = $_POST['jml'];
										$tanggal_pakai = $_POST['tgl-pakai'];
										$sql_bbm = "INSERT INTO `db_bahan_dipakai` (`id_bahan`,`jumlah`,`tanggal_pakai`) VALUES ('$id_bahan','$jumlah', '$tanggal_pakai')";
										$conn->query($sql_bbm);
										$conn->close();

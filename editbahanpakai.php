...
$queri = "SELECT db_bahan_dipakai.*, db_bahan.nama_bahan FROM db_bahan_dipakai 
		  INNER JOIN db_bahan ON db_bahan_dipakai.id_bahan=db_bahan.id_bahan where id_pakai = '$id'";
...
<head>
  ...
  <title>Data | Tambah Kegiatan Bahan</title>
        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Laporan Kegiatan Bahan</h2>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" role="form" action="aksi_edit_bahan_pakai.php" method="post">
                    ...
                    <div class="form-group">
					  ...
					  <input type="hidden" name="id-pakai" value="<?php echo "$nomor";?>">
                      <div class="input-group col-md-5 col-sm-5 col-xs-12">
                        <select class="form-control" id="id-bahan" name="id-bahan" required="required">
							...
							<option value="<?php echo "$idbahan";?>"> <?php echo "$namabahan";?></option>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jml-tb">Jumlah (Kg) <span class="required">*</span></label>
                      <div class="input-group col-md-2 col-sm-2 col-xs-12">
                        <input type="text" id="jml" name="jml" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo "$jumlah";?>">
                      </div>
                    </div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgl-masuk">Tanggal Bahan Dipakai <span class="required">*</span></label>
											<div class="input-group col-md-3 col-sm-3 col-xs-12">
												<span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
												<input type="date" id="tgl-pakai" name="tgl-pakai" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo "$Tgl";?>">
											</div>
										</div>
